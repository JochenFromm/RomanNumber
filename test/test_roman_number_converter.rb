...
describe RomanNumber::Converter do
  ...
  describe "knwows complex numbers" do
    ...
    it "must convert years and big numbers" do
      ...
      test_combination(1066,"MLXVI")
      test_combination(1484,"MCDLXXXIV")
      test_combination(1488,"MCDLXXXVIII")
      test_combination(1499,"MCDXCIX")
      test_combination(1588,"MDLXXXVIII")
      test_combination(1648,"MDCXLVIII")
      test_combination(1732,"MDCCXXXII")
      test_combination(1789,"MDCCLXXXIX")
      test_combination(1800,"MDCCC")
      test_combination(1900,"MCM")
      test_combination(1904,"MCMIV")
      test_combination(1954,"MCMLIV")
      test_combination(1970,"MCMLXX")
      test_combination(1971,"MCMLXXI")
      test_combination(1972,"MCMLXXII")
      test_combination(1973,"MCMLXXIII")
      test_combination(1974,"MCMLXXIV")
      test_combination(1975,"MCMLXXV")
      test_combination(1976,"MCMLXXVI")
      test_combination(1977,"MCMLXXVII")
      test_combination(1978,"MCMLXXVIII")
      test_combination(1979,"MCMLXXIX")
      test_combination(1980,"MCMLXXX")
      test_combination(1981,"MCMLXXXI")
      test_combination(1982,"MCMLXXXII")
      test_combination(1983,"MCMLXXXIII")
      test_combination(1984,"MCMLXXXIV")
      test_combination(1985,"MCMLXXXV")
      test_combination(1986,"MCMLXXXVI")
      test_combination(1987,"MCMLXXXVII")
      test_combination(1988,"MCMLXXXVIII")
      test_combination(1989,"MCMLXXXIX")
      test_combination(1990,"MCMXC")
      test_combination(1991,"MCMXCI")
